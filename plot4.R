...
filterData$Voltage<-as.integer(filterData$Voltage)
filterData$Global_reactive_power<-as.integer(filterData$Global_reactive_power)
...
plot(filterData$timestamp,filterData$Global_active_power,type="l",xlab="",ylab="Global Active Power")
plot(filterData$timestamp,filterData$Voltage,type="l",xlab="",ylab="Voltage")
...
plot(filterData$timestamp,filterData$Global_reactive_power,type="l",xlab="",ylab="Global_reactive_power")
